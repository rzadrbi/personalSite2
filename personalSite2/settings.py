...
SECRET_KEY = 'django-insecure-5&w$m8(-^&6q=s!eyzg*vb2vn$t#)^4da+_a)3$90_fy5qz8ae'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'utils.context_processors.info_context',
...
WSGI_APPLICATION = 'personalSite2.wsgi.application'
